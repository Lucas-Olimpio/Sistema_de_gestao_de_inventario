...
import { Check, Trash2, Truck, XCircle, Eye } from "lucide-react";
...
export default function OrderTable({
  ...
  const columns: Column<PurchaseOrder>[] = [
    ...
    {
      header: "Status",
      cell: (order) => <StatusBadge status={order.status} type="purchase" />,
    },
    {
      header: "Data",
      cell: (order) => (
      ...
      cell: (order) => (
        ...
        >
          ...
          {order.status === "APROVADA" && (
            <>
              <button
                onClick={() => onUpdateStatus(order.id, "EM_TRANSITO")}
